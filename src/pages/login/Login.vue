		        ...
		        <div class="col-xl-4" style="margin: 0 auto;">
		            ...
		            <div class="login-register-page">
		                <div class="welcome-text">
		                    <h4><b>欢迎访问牛库</b></h4>
		                    <span>还没有注册？ 请<a href="/">创建帐号!</a></span>
		                </div>

		                <form method="post" id="register-account-form" class="login-form validform" action="/">
		                    <div class="margin-bottom-14" title="请输入登录账号">
		                        <input type="text" class="input-text with-border" name="username" placeholder="用户名/邮箱/手机号码" value="/" nullmsg="请输入登录账号" datatype="*" errormsg="登录账号错误">
							</div>
