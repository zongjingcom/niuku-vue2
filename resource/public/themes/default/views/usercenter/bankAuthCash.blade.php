                        ...
                        <div class="row">
                            <div class="single-form margin-bottom-50 col-xl-9 col-lg-10 col-md-11">
                                ...
                                <form class="registerform" method="post"
                                    action="{!! url('user/verifybankauthcash') !!}">
                                    {!! csrf_field() !!}
                                    <input type="hidden" name="bankAuthId"
                                        value="{!! Crypt::encrypt($authInfo['id']) !!}">
                                    <div class="col-md-12">
                                        <div class="payauth-num">
                                            <div class="text-right h5" style="width: 108px;padding:0 15px">打款金额</div>
                                            <div class="" style="padding:0 15px">
                                                <input class="with-border Validform_error" type="text" name="cash"
                                                    datatype="number" errormsg="请输入正确的金额格式" nullmsg="输入金额">
